...
- (void)tableView:(UIView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
	if (searchDelegate) {
...
- (UITableViewCell *)tableView:(UIView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
