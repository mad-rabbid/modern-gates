#import "MRFormNumberCell.h"
#import "MRFormNumberElement.h"

@implementation MRFormNumberCell {
...
- (MRFormNumberElement *)numberElement {
    return (MRFormNumberElement *)self.element;
}
...
- (IBAction)didCalculatorButtonTouch:(UIButton *)sender {
	...
	MRCalculatorViewController *content = [[MRCalculatorViewController alloc] initWithNibName:@"MRCalculatorView" bundle:[NSBundle mainBundle]];
...
- (void)calculatorViewController:(MRCalculatorViewController *)controller didEnterTouchWithResult:(NSString *)result {
    [self updateElementFromTextValue:result];
    [self hideCalculator:nil];
}
@end
